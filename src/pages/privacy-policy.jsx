	...
	return (
		<BigContent data_head={data_head}>
			<section className='big_content'>
				<p>
					Through Your Use of the Application and Services, You may provide Us with certain
					information. By using the Application or the Services, You authorize the Company to use
				...
				<p>
					We reserve the right to make changes to our Privacy Policy at any time and for any reason.
				...
				<p>
					...
					name or billing information. Depending on how You use Our Application or Services, We may
					also receive information from external applications You use to access Our Application, or
					We may receive informatiocn through various web technologies, such as cookies, log files,
					clear gifs, web beacons or others. In addition, we may collect information about you in a
					variety of ways. The information we may collect via the Application depends on the content
				...
				<p>
					...
					activities related to the Application, such as chat, posting messages in comment sections
					or in our forums, liking posts, sending feedback, and responding to surveys. If you choose
					to share data about yourself via your profile, online chat, or other interactive areas of
					the Application, please be advised that all data you disclose in these areas is public and
				...
				<p>
					...
					your native actions that are integral to the Application, including liking, re-blogging,
					or replying to a post, as well as other interactions with the Application and other users
				...
				<p>
					...
					exchange, or request information about our services from the Application. We store only
					very limited, if any, financial information that we collect. Otherwise, all financial
					information is stored by our payment processor, [Payment Processor Name], and you are
					encouraged to review their privacy policy and contact them directly for responses to your
					questions.
				</p>
				<h5>4. Facebook Permissions</h5>
				<p>
					The Application may by default access your Facebook basic account information, including
					your name, email, gender, birthday, current city, and profile picture URL, as well as
					other information that you choose to make public. We may also request access to other
					permissions related to your account, such as friends, checkins, and likes, and you may
				...
				<p>
					User information from social networking sites, such as [social media sites that your
					mobile app connects to], including your name, your social network username, location,
					gender, birth date, email address, profile picture, and public data for contacts, if you
					connect your account to such social networks. This information may also include the
				...
				<p>
					...
					location-based services. If you wish to change our access or permissions, you may do so in
				...
				<p>
					...
					your mobile device’s [list all features that your app can connect to (eg. bluetooth)]. If
				...
				<p>
					...
					of your operating system, phone number, country, location, and any other data you choose
					to provide.
				</p>
				...
				<p>
					...
					continued good experience on Our Application, including through email communication. We
					may also track certain of the passive information received to improve Our marketing and
					analytics, and for this, We may work with third-party providers. Having accurate
					information about you permits us to provide you with a smooth, efficient, and customized
					experience. Specifically, we may use information collected about you via the Application
					to:
				</p>
				<ul className='list'>
					...
					<li>
						...
						promotions and the Application to you.
					</li>
					...
					<li>
						Generate a personal profile about you to make future visits to the Application more
						personalized.
					</li>
				...
				<p>
					...
					passive information We receive from the use of various technologies. Please be aware that
					the Company will still receive information about You that You have provided, such as Your
					email address. If You choose to terminate Your account, we will deactivate or delete your
					account and information from our active databases. However, some information may be
