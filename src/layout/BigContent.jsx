			...
			>
				<Link href='/'>
					<a className='icon_back'>
						<img src='./images/icon_back_b.svg' alt='icon back to home' />
					</a>
				</Link>
				<a href='#'>
					<figure className='app_store app_store_min'>
						<img src='./images/app_store_big.svg' alt='icon app store' />
					</figure>
				</a>
			</header>
			<section className='container text-center'>
				<img width='150px' src='./images/dharma.svg' alt='Dharma App' />
			</section>
